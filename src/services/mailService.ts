...
export const MailService = {
    sendOTP: async (to: string, otp: string) => {
        const mailOptions = {
            from: `"Digifoncier Security" <${process.env.MAIL_USER || "fayellnouh@gmail.com"}>`,
            to,
            subject: "Digifoncier Access Code",
            text: `Your one-time password (OTP) is: ${otp}. This code expires in 10 minutes.`,
            html: `
                <div style="font-family: sans-serif; padding: 20px; border: 1px solid #eee; border-radius: 10px; max-width: 500px; margin: auto;">
                    <h2 style="color: #1e3a8a; text-transform: uppercase;">Digifoncier Verification</h2>
                    <p style="color: #64748b;">You requested a password reset for your Digifoncier account.</p>
                    ...
                    <p style="font-size: 10px; color: #cbd5e1; text-align: center;">Digifoncier • National Digital Registry</p>
                </div>
            `,
        };
